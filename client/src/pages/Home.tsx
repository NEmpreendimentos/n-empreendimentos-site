  ...
  return (
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="section-pad proof-section"><div className="container proof-layout"><div><span className="section-index">N/ 04 — prova social</span><h2>O próximo projeto<br /><span>pode ser o seu.</span></h2></div><div className="proof-note"><ShieldCheck size={20} /><p>Esta área está pronta para receber depoimentos reais de clientes da N. Empreendimentos. A confiança só vale quando vem de experiências verdadeiras.</p></div></div><div className="container testimonial-placeholders"><div className="testimonial-placeholder"><span className="placeholder-number">01</span><div className="placeholder-lines"><span /><span /><span /></div><small>depoimento real em breve</small></div><div className="testimonial-placeholder active-placeholder"><span className="placeholder-number">02</span><div className="placeholder-lines"><span /><span /><span /></div><small>seu resultado pode estar aqui</small></div><div className="testimonial-placeholder"><span className="placeholder-number">03</span><div className="placeholder-lines"><span /><span /><span /></div><small>depoimento real em breve</small></div></div></section>
